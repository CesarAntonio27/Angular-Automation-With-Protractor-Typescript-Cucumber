...
var BasePages_1 = require("./BasePages");
var Locators = {
    heading: {
        type: BasePages_1.IdentificationType[BasePages_1.IdentificationType.Xpath],
        value: "//course-thumb/div//h2[text()=' Selenium Framework development ']"
    },
    headings: {
        type: BasePages_1.IdentificationType[BasePages_1.IdentificationType.Css],
...
var HomePage = /** @class */ (function (_super) {
    ...
    HomePage.prototype.ClikFirstHeading = function (heading) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
